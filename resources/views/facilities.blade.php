    ...
    @section('content')
        ...
        <section class="py-24 bg-gradient-to-br from-green-600 to-green-800 relative overflow-hidden">
            ...
            <div class="container mx-auto px-6 text-center relative z-10">
                <span class="inline-block px-4 py-1 rounded-full bg-white/20 backdrop-blur-sm text-white text-sm font-medium mb-4">Explore Our Facilities</span>
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">Fasilitas <span class="text-yellow-300">Nusantara Edupark</span></h1>
                <p class="text-xl text-white/80 max-w-2xl mx-auto">Berbagai fasilitas modern dan nyaman untuk pengalaman kunjungan yang berkesan</p>
            </div>
        </section>
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <div class="p-5 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                                            <span class="bg-green-600 text-white text-xs uppercase tracking-wider py-1 px-2 rounded-md">Facility</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-7">
                                    <h3 class="text-2xl font-bold text-gray-800 mb-3 group-hover:text-green-700 transition-colors">
                                        {{ $facility->title }}
                                    </h3>
                                    <p class="text-gray-600 mb-4 leading-relaxed">{{ $facility->description }}</p>

                                    @if($facility->detail)
                                        <div class="p-5 bg-green-50 border border-green-100 rounded-xl mt-5 text-sm text-gray-700">
