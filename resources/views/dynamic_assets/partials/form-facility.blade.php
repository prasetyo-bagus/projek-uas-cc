<form method="POST"
    ...
    <div class="col-span-2">
        <div class="mb-4">
            <label class="block text-gray-700 font-medium mb-2">Ikon / Gambar Fasilitas</label>
    ...
    <div class="col-span-2">
        <div class="mb-4">
            ...
            <input type="text" name="description" value="{{ old('description', $data->description ?? '') }}"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors"
                placeholder="Masukkan keterangan singkat fasilitas">
        </div>
    </div>

    <div class="col-span-2">
        <div class="mb-4">
            <label class="block text-gray-700 font-medium mb-2">Detail Fasilitas</label>
            <textarea name="detail" rows="4"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors"
                placeholder="Masukkan detail fasilitas">{{ old('detail', $data->detail ?? '') }}</textarea>
        </div>
    </div>
    ...
    <div class="col-span-2">
        <div class="mb-4">
            ...
            <p class="text-xs text-gray-500 mt-1">Fasilitas yang aktif akan ditampilkan di halaman utama</p>
        </div>
    </div>
