        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-1">
                    Perbarui informasi
                    {{ strtolower(
                        $dynamicAsset->type == 'BANNER'
                            ? 'Banner'
                            : ($dynamicAsset->type == 'GALERY'
                                ? 'Galeri'
                                : ($dynamicAsset->type == 'FACILITY'
                                    ? 'Fasilitas'
                                    : ($dynamicAsset->type == 'PACKET'
                                        ? 'Paket'
                                        : ($dynamicAsset->type == 'SPONSOR'
                                            ? 'Sponsor'
                                            : 'Tidak diketahui')))),
                    ) }}
                </p>
                    ...
                    {{ $dynamicAsset->type == 'BANNER'
                        ...
                        : ($dynamicAsset->type == 'GALERY'
                            ...
                            : ($dynamicAsset->type == 'FACILITY'
                                ...
                                : ($dynamicAsset->type == 'PACKET'
                                    ? 'fa-box'
                                    : ($dynamicAsset->type == 'LAYANAN'
                                        ? 'fa-box'
                                        : ($dynamicAsset->type == 'SPONSOR'
                                            ? 'fa-handshake'
                                            : 'fa-circle-question'))))) }} text-lg"></i>
                </div>
                <div>
                ...
                <div class="space-y-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center relative"
                                    ...
                                    <div id="placeholder"
                                        ...
                                        <p class="text-xs text-gray-400 mt-1">JPG, PNG atau JPEG (Rasio 16:9 untuk hasil
                                            terbaik)</p>
                                    </div>
                                    <div id="preview" class="{{ $dynamicAsset->image ? '' : 'hidden' }}">
                                        <img src="{{ asset('storage/' . $dynamicAsset->image) }}" alt="Preview"
                    ...
                    @elseif($dynamicAsset->type == 'GALERY')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="description"
                                value="{{ old('description', $dynamicAsset->description) }}"
                                class="w-full border rounded p-2">
                        </div>
                    @elseif ($dynamicAsset->type == 'PACKET')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="weekday_price"
                                    value="{{ old('weekday_price', $dynamicAsset->weekday_price ?? '') }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors"
                            ...
                            <div>
                                ...
                                <input type="text" name="weekend_price"
                                    value="{{ old('weekend_price', $dynamicAsset->weekend_price ?? '') }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors"
                                    placeholder="Rp 50.000" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="detail" name="detail" rows="4" class="w-full border rounded p-2">{{ old('detail', $dynamicAsset->detail) }}</textarea>
                        </div>
                    @elseif ($dynamicAsset->type == 'SPONSOR')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center relative">
                                ...
                                <div id="preview" class="{{ $dynamicAsset->image ? '' : 'hidden' }}">
                                    <img src="{{ $dynamicAsset->image ? asset('storage/' . $dynamicAsset->image) : '#' }}"
                                        alt="Preview" class="max-h-48 mx-auto rounded-lg">
                                    <button type="button" id="removeImage"
                                        class="mt-2 text-red-500 text-sm hover:text-red-700">
                                        <i class="fa-solid fa-xmark mr-1"></i> Hapus Gambar
                                    </button>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title"
                                    value="{{ old('title', $dynamicAsset->title) }}" required
                            ...
                            <div>
                                ...
                                <select name="category" id="category" required
                                    ...
                                    <option value="Pertanian"
                                        {{ old('category', $dynamicAsset->category) == 'Pertanian' ? 'selected' : '' }}>
                                        Pertanian</option>
                                    <option value="Peternakan"
                                        {{ old('category', $dynamicAsset->category) == 'Peternakan' ? 'selected' : '' }}>
                                        Peternakan</option>
                                    <option value="Perkebunan"
                                        {{ old('category', $dynamicAsset->category) == 'Perkebunan' ? 'selected' : '' }}>
                                        Perkebunan</option>
                                </select>
                            </div>
                            ...
                            <!-- Kolom Ikon -->
                            <div>
                                <label for="icon" class="block text-gray-700 font-medium mb-2">Ikon (Font Awesome)
                                    <span class="text-red-500">*</span></label>
                                <input type="text" name="icon" id="icon"
                                    value="{{ old('icon', $dynamicAsset->icon) }}" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    placeholder="Contoh: fas fa-seedling">
                                <p class="text-gray-500 text-xs mt-1">Masukkan kelas ikon dari Font Awesome (mis. fas
                                    fa-seedling, fas fa-horse)</p>
                            ...
                            <div>
                                ...
                                <div class="mt-1 mb-2">
                                    <img src="{{ asset('storage/' . $dynamicAsset->image) }}"
                                        class="w-48 h-36 object-cover mt-2 rounded">
                                </div>
                                <input type="file" name="image" id="image" accept="image/*"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                <p class="text-gray-500 text-xs mt-1">Biarkan kosong jika tidak ingin mengubah gambar.
                                    Ukuran disarankan: 800x600px (rasio 4:3) untuk tampilan yang seragam</p>
                            </div>

                            <!-- Kolom Detail Item -->
                            <div class="md:col-span-2">
                                <label class="block text-gray-700 font-medium mb-2">Detail Layanan <span
                                        class="text-red-500">*</span></label>
                                        ...
                                        @foreach ($dynamicAsset->service_items as $index => $item)
                                            <div class="item-row border border-gray-200 rounded-lg p-4 bg-gray-50">
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div>
                                                        <label class="block text-gray-700 text-sm mb-1">Deskripsi
                                                            Item</label>
                                                ...
                                                <button type="button"
                                                    class="remove-item mt-2 text-red-500 text-sm hover:text-red-700"
                    ...
                    @else
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="detail" rows="4" class="w-full border rounded p-2">{{ old('detail', $dynamicAsset->detail) }}</textarea>
                        </div>
