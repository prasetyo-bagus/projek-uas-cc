...
@section('content')
        ...
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Nusantara Edupark menawarkan berbagai layanan wisata edukatif
                    yang dirancang untuk memberikan pengalaman belajar yang menyenangkan dan bermanfaat bagi pengunjung dari
                    segala usia.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-6 relative">
                            <span class="relative z-10">{{ $servicesByCategory['Pertanian'][0]->title }}</span>
    ...
    @else
        <!-- Default Agricultural Education if no data -->
            ...
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="order-1 md:order-2">
                        <h2 class="text-3xl font-bold text-gray-800 mb-6 relative">
                            <span class="relative z-10">{{ $servicesByCategory['Peternakan'][0]->title }}</span>
    ...
    @else
        <!-- Default Livestock Interaction if no data -->
        ...
        <section id="perkebunan" class="py-16 bg-violet-50">
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-6 relative">
                            <span class="relative z-10">{{ $servicesByCategory['Perkebunan'][0]->title }}</span>
    ...
    @else
        <!-- Default Plantation Tours if no data -->
