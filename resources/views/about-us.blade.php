            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mb-6">
                        Nusantara Edupark didirikan pada tahun 2021 dengan visi mengembangkan pariwisata berbasis pendidikan
                        dalam bidang pertanian, peternakan, dan perkebunan. Berawal dari keinginan untuk memperkenalkan
                        kembali sektor agraris kepada masyarakat terutama generasi muda.
                    </p>
                    <p class="text-gray-600 mb-6">
                        Berlokasi di Jalan Raya Dungus, Kelurahan Munggut, Mojopurno, Kec. Wungu, Kabupaten Madiun, Jawa
                        Timur, Nusantara Edupark hadir dengan konsep wisata yang menggabungkan keseruan berwisata dengan
                        nilai-nilai edukasi yang bermanfaat bagi semua kalangan.
                    </p>
                    <p class="text-gray-600">
                        Melalui berbagai program wisata edukatif dan pengalaman interaktif, Nusantara Edupark terus
                        berkomitmen untuk menjadi pusat pendidikan informal mengenai pertanian, peternakan, dan perkebunan
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Kami hadir dengan tujuan yang jelas untuk memajukan sektor
                    pertanian, peternakan, dan perkebunan melalui pendekatan edukasi yang menyenangkan.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div
                    class="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-all transform hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 text-center">
                        Menjadi destinasi wisata edukasi terdepan di Indonesia yang mengintegrasikan konsep pendidikan,
                        pelestarian lingkungan, dan pengembangan ekonomi lokal berbasis pertanian, peternakan, dan
                        perkebunan.
                    </p>
                </div>
                ...
                <div
                    ...
                    <ul class="text-gray-600 space-y-3">
                        <li class="flex items-start">
                            ...
                            <span>Menyediakan pengalaman belajar interaktif tentang proses pertanian, peternakan, dan
                                perkebunan.</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                            <span>Menumbuhkan kesadaran akan pentingnya pelestarian lingkungan dan praktik pertanian
                                berkelanjutan.</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto">Kami berkolaborasi dengan berbagai instansi dan lembaga untuk
                    menciptakan pengalaman edukatif terbaik.</p>
            </div>
            ...
            <div class="flex flex-wrap justify-center items-center gap-10 md:gap-16">
                ...
                @empty
                    <div class="flex flex-wrap justify-center items-center gap-10 md:gap-16">
                        <div class="group">
                            <a href="#" class="block">
                                <img src="{{ asset('storage/images/about/partner-1.png') }}" alt="Partner 1"
                                    class="h-24 md:h-28 filter grayscale hover:grayscale-0 transition-all duration-300 hover:scale-110">
                            </a>
                        </div>
                        <div class="group">
                            <a href="#" class="block">
                                <img src="{{ asset('storage/images/about/partner-2.png') }}" alt="Partner 2"
                                    class="h-24 md:h-28 filter grayscale hover:grayscale-0 transition-all duration-300 hover:scale-110">
                            </a>
                        </div>
                        <div class="group">
                            <a href="#" class="block">
                                <img src="{{ asset('storage/images/about/partner-3.png') }}" alt="Partner 3"
                                    class="h-24 md:h-28 filter grayscale hover:grayscale-0 transition-all duration-300 hover:scale-110">
                            </a>
                        </div>
                        <div class="group">
                            <a href="#" class="block">
                                <img src="{{ asset('storage/images/about/partner-4.png') }}" alt="Partner 4"
                                    class="h-24 md:h-28 filter grayscale hover:grayscale-0 transition-all duration-300 hover:scale-110">
                            </a>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                    ...
                    <p class="text-gray-600 mb-8">
                        Kami siap melayani Anda untuk informasi lebih lanjut, pemesanan kunjungan kelompok, atau kerjasama
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Jl. Raya Dungus, Kelurahan Munggut, Mojopurno, Kec. Wungu,
                                    Kabupaten Madiun, Jawa Timur 63181</p>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="rounded-lg overflow-hidden shadow-lg h-96">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.225468086152!2d111.5581496751084!3d-7.658890392357514!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e79bde6649ef6b3%3A0xeb63ac06162d7710!2sNusantara%20Edupark!5e0!3m2!1sid!2sid!4v1746713245419!5m2!1sid!2sid"
    ...
    <section class="py-20 bg-purple-900 text-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-xl text-gray-200 mb-10 max-w-3xl mx-auto">
                Jadwalkan kunjungan Anda untuk pengalaman wisata edukatif yang tak terlupakan bersama keluarga dan
                teman-teman.
            </p>
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('packets') }}"
                    class="bg-white text-purple-900 hover:bg-gray-200 font-bold py-3 px-8 rounded-full transition-all inline-flex items-center justify-center">
