    ...
    <div class="bg-gray-50 min-h-screen py-16">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Baca pengalaman pengunjung lain dan bagikan pengalaman
                    Anda bersama Nusantara Edupark</p>
            </div>
                ...
                <div class="bg-white p-5 rounded-xl shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="{{ route('testimonials.all') }}"
                            class="rating-filter {{ !request('rating') ? 'bg-purple-100 border-purple-500 text-purple-700' : 'bg-gray-50 hover:bg-gray-100 border-gray-200 text-gray-700' }} border rounded-lg px-4 py-2 transition-all text-sm font-medium">
                            Semua Rating
                        </a>
                        @for ($i = 5; $i >= 1; $i--)
                            <a href="{{ route('testimonials.all', ['rating' => $i]) }}"
                                class="rating-filter {{ request('rating') == $i ? 'bg-purple-100 border-purple-500 text-purple-700' : 'bg-gray-50 hover:bg-gray-100 border-gray-200 text-gray-700' }} border rounded-lg px-4 py-2 transition-all text-sm font-medium flex items-center">
                                ...
                                <div class="flex items-center mt-6">
                                    ...
                                    @else
                                        <div class="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center">
                                            <span
                                                class="text-lg font-medium text-purple-600">{{ substr($testimonial->nama, 0, 1) }}</span>
                                        </div>
                                    @endif
                                    <div class="ml-3">
